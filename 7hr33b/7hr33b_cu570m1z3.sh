...
sed -i 's/5e72e4/bc1142/g' feeds/luci/applications/luci-app-argon-config/root/etc/config/argone
sed -i 's/483d8b/bc1142/g' feeds/luci/applications/luci-app-argon-config/root/etc/config/argone
sed -i 's/normal/dark/g' feeds/luci/applications/luci-app-argon-config/root/etc/config/argone
