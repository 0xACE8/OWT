...
sed -i 's/"Argonne 主题设置"/"主题设置"/g' feeds/kenzo/luci-app-argonne-config/po/zh-cn/argonne-config.po
mv feeds/small8/luci-theme-argonne/htdocs/luci-static/argonne/img/argon.svg feeds/kenzo/luci-theme-argonne/htdocs/luci-static/argonne/img/argonne.svg
...
wget https://raw.githubusercontent.com/0xACE8/OWT/main/reg/banner -O package/base-files/files/etc/banner
