...
#2. Modify Hostname
sed -i 's/ImmortalWrt/Youku YK-L1/g' package/base-files/files/bin/config_generate
...
#rm -rdf feeds/packages/libs/gnutls
#rm -rdf package/feeds/packages/gnutls
#git clone https://github.com/0xACE8/gnutls feeds/packages/libs/gnutls
#git clone https://github.com/0xACE8/gnutls package/feeds/packages/gnutls
